...
function loadProds() {
    fetch("/BuyGo/api/front_end/member/pa/prod/paProdLoad", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
    })
        .then(resp => resp.json())
            ...
            for (let data of datas) {
                ...
                let prod_div = `
                    <div class="product" data-product-id="${data.paProdNo}"
                        data-category="${changeObjText(data.paProdObjNo)}" data-brand="brand1"
                        data-price="${data.paProdPrice}" data-colors="red|blue|black|white" data-size="S|M|L">
                        <div class="entry-media">
                            <img data-src="${prpics_url}"
                                alt="" class="lazyLoad thumb" />
                            <div class="hover">
                                <a href="${full}/BuyGo/front_end/pages/member/pa/paProduct.html?prodId=${data.paProdNo}" class="entry-url"></a>
                                <ul class="icons unstyled">
                                    ...
                                    <li>
                                        <a href="#" class="circle add-to-cart" onclick="addToCart(${data.paProdNo});">
                        ...
                        <div class="entry-main">
                            <h5 class="entry-title">
                                <a href="${full}/BuyGo/front_end/pages/member/pa/paProduct.html?prodId=${data.paProdNo}">${data.paProdName}</a>
                            </h5>
                            <div class="entry-description visible-list">
                                <p>${data.paProdContent}</p>
                            </div>
                            <div class="entry-price">
                                <strong class="price">$ ${data.paProdPrice}</strong>
                                <a href="#"
                                    class="btn btn-round btn-default add-to-cart visible-list" onclick="addToCart(${data.paProdNo});">加入購物車</a>
                            </div>
                        </div>
                    </div>
                `;
