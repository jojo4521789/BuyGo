...
@WebServlet("/needLoginApi/front_end/loadGpaOrderByLimitAndOffsetAndSearchStr")
public class LoadGpaOrderByLimitAndOffsetAndSearchStrServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
		...
		List<GpaSo> gpaSoList = SERVICE.loadByMemberNoAndSoStatAndLimitAndOffsetAndSearchStr((Integer)(session.getAttribute("memberNo")), gpaSoSearchPageDTO.getGpaSoStat(), gpaSoSearchPageDTO.getLimit(), gpaSoSearchPageDTO.getOffset(), gpaSoSearchPageDTO.getSearchStr());
