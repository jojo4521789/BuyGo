...
@WebServlet("/needLoginApi/front_end/loadGpaSoCountByMemberNoAndSoStatAndSearchStr")
public class LoadGpaSoCountByMemberNoAndSoStatAndSearchStrServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
		...
		Integer gpaSoCount = SERVICE.loadGpaSoCountByMemberNoAndSoStatAndSearchStr((Integer)(session.getAttribute("memberNo")), gpaSoSearchPageDTO.getGpaSoStat(), gpaSoSearchPageDTO.getSearchStr());
