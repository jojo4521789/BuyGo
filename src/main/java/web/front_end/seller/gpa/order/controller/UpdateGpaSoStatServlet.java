...
@WebServlet("/needLoginApi/front_end/updateGpaSoStat")
public class UpdateGpaSoStatServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		boolean status = SERVICE.updateGpaSoStatByGpaSoNo(gpaSo.getGpaSoNo(), gpaSo.getGpaSoStat());
