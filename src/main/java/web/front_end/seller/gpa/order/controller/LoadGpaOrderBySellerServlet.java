...
@WebServlet("/needLoginApi/front_end/loadGpaOrderBySellerServlet")
public class LoadGpaOrderBySellerServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		List<GpaSo> gpaSolist = SERVICE.loadSoBySellerMemberNoAndSoStat((Integer)(session.getAttribute("memberNo")), selectPage);
